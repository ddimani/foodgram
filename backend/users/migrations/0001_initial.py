    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Введите ваш никнейм', max_length=150, unique=True, validators=[core.validators.validator_username], verbose_name='Никнейм')),
                ('email', models.EmailField(help_text='Введите вашу электронную почту', max_length=254, unique=True, verbose_name='Почта')),
